  ...
  <section class="Gallary-foto">
    <div class="Gallary-container">
      <div class="Gallary-wrapper">
        <figure class="foto1">
          <img src="https://frndsdubai.com/wp-content/uploads/2022/12/FRNDS-CAFE_Tape-Agency_008_07.11.2022-2048x1365.jpg" alt="foto">
        </figure>
        <figure class="foto2">

          <img src="https://frndsdubai.com/wp-content/uploads/2024/02/IMG_7415.jpg" alt="foto">
        </figure>
      </div>
      <div class="Gallary-wrapper">
        <figure class="foto3">

          <img src="https://frndsdubai.com/wp-content/uploads/2024/02/IMG_7421.jpg" alt="foto">
        </figure>
        <figure class="foto4">

          <img
          src="https://frndsdubai.com/wp-content/uploads/2024/02/IMG_7417.jpg"
            alt="foto">
        </figure>
      </div>
      <div class="Gallary-wrapper">
        <figure class="foto5">
          ...
          <img src="https://frndsdubai.com/wp-content/uploads/2023/03/4W6A8586.jpg" alt="foto">
        </figure>
        <figure class="foto6">

          <img src="https://frndsdubai.com/wp-content/uploads/2024/02/IMG-19.jpeg" alt="foto">
        </figure>
      </div>
      <div class="Gallary-wrapper">
        <figure class="foto7">
          ...
          <img
          src="https://frndsdubai.com/wp-content/uploads/2024/02/IMG_7419.jpg"
            alt="foto">
        </figure>
        <figure class="foto8">
